...
<!-- !PAGE CONTENT! -->
 ...
 <!-- form -->
  <div class="w3-container w3-padding-24 w3-white" style="margin-top: 50px;"> 
    <h4 class="w3-center" style="font-size: 25pt; margin-top: 40px; margin-bottom:-65px;" id="lienhe"><b>Thêm loại hàng</b></h4>
    <form action="connectlh.php" method="post">
    
    <div class="w3-row-padding w3-center w3-padding-24" style="margin:0 -16px"></div>
    
    <hr class="w3-opacity">
    <!-- <form action="/action_page.php" target="_blank"> -->
      <b><label>Mã loại: </label></b> <input type="Maloai" id="Maloai"  size="5" name="Maloai">
      <div class="w3-section">
        <label><b>Tên loại:</b></label>
        <input type="Tenloai" style="block-size: 40px;" class="w3-input w3-border" required="" name="Tenloai">
      </div>
     <!--  <div class="w3-section">
        <label><b>Đơn vị tính:</b></label>
        <input type="Diachi" style="block-size: 40px;" class="w3-input w3-border"  required="" name="Diachi">
      </div>
      <div class="w3-section">
        <label><b>Công dụng:</b></label>
        <input type="Sotaikhoan" style="block-size: 40px;" class="w3-input w3-border"  required="" name="Sotaikhoan">
      </div>
       <div class="w3-section">
        <label><b>Mô tả:</b></label>
        <input type="Sodienthoai" class="w3-input w3-border"  required="" name="Sodienthoai">
      </div> -->
      <div class="clearfix"></div>
      <button type="submit" name="loaihang" class="w3-button w3-green w3-margin-bottom"><i style="color: white;" class="fa fa-paper-plane w3-margin-right"></i>Thêm loại hàng</button>
    </form>
  </div>
