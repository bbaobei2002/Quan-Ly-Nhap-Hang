...
if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE purchase_orders SET 
                   store_id = '$store_id',
    ...
    if ($conn->query($sql_update) === TRUE) {
        echo "<script>alert('Cập nhật thành công'); window.location.href='dsphieu.php';</script>";
    } else {
...
if (isset($_GET['order_id'])) {
    ...
    $sql_order = "SELECT * FROM purchase_orders WHERE id = $order_id";
    ...
    if ($result_order->num_rows > 0) {
        ...
        <body>
            <div class="container">
                ...
                <form action="uppn.php" method="post">
                    <input type="hidden" name="order_id" value="<?php echo $order_id; ?>">
                    <div class="form-group">
                        <label for="store_id"><strong>Mã cửa hàng:</label></strong>
                        <input type="text" class="form-control" id="store_id" name="store_id" value="<?php echo $order['store_id']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="distributor_id"><strong>Mã nhà phân phối:</label></strong>
                        <input type="text" class="form-control" id="distributor_id" name="distributor_id" value="<?php echo $order['distributor_id']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="invoice_number"><strong>Số hóa đơn:</label></strong>
                        <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="<?php echo $order['invoice_number']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="invoice_date"><strong>Ngày ghi hóa đơn:</label></strong>
                        <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="<?php echo $order['invoice_date']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="order_date"><strong>Ngày đặt hàng:</label></strong>
                        <input type="date" class="form-control" id="order_date" name="order_date" value="<?php echo $order['order_date']; ?>" required>
                    </div>
                   
                    <div class="form-group">
                        <label for="created_by"><strong>Mã nhân viên lập:</label></strong>
                        <input type="text" class="form-control" id="created_by" name="created_by" value="<?php echo $order['created_by']; ?>" required>
                    </div>
        ...
        echo "<div class='alert alert-warning'>Không tìm thấy phiếu nhập.</div>";
    }
} else {
