...
// }
  ...
  if(isset($_POST['employees'])){
         ...
         if($conn ->query(
                           "INSERT INTO employees (full_name, date_of_birth, gender, address, id_card_number, issue_date, bank_account_number, email, phone_number) VALUES ('$full_name', '$date_of_birth', '$gender', '$address', '$id_card_number', '$issue_date', '$bank_account_number', '$email', '$phone_number')"   
                         )
            )
                    {
...
<!-- !PAGE CONTENT! -->
 ...
 <!-- form -->
  <div class="w3-container w3-padding-large w3-white" style="margin-top: 50px;"> 
    ...
    <b><label>Mã nhân viên: </label></b> <input type="employee_id" id="employee_id"  size="5" name="employee_id">
    ...
    <!-- <form action="/action_page.php" target="_blank"> -->
      ...
      <div class="w3-section">
        ...
        <input type="issue_date" style="block-size: 40px;" class="w3-input w3-border"  required="" name="issue_date">
      </div>
