...
// }
  ...
  if(isset($_POST['dangky'])){
         ...
         if($conn ->query(
                           "INSERT INTO user (username, userpassword, usergmail) VALUES ('$username', '$userpassword', '$usergmail')"   
                         )
            )
                    {
                         header("Location:/qlnh/login.php");
                    } else {
    ...
    <h2>Đăng nhập</h2>
        <form action="hpage.php" method="post">
            ...
            <h6><a href="#">Quên mật khẩu?</a></h6>
                ...
                <input type="submit" value="Đăng nhập" href="hpage.php" name="login">
        </form>
