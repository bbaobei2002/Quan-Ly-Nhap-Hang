...
if (isset($_POST['update'])) {
    ...
    if ($conn->query($sql_update) === TRUE) {
        echo "<script>alert('Cập nhật thành công'); window.location.href='dsmh.php';</script>";
    } else {
    ...
    if ($result_product->num_rows > 0) {
        ...
        <body>
            <div class="container">
                ...
                <form action="upmh.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $product_id; ?>">
                    <div class="form-group">
                        <label for="pdname">Tên mặt hàng:</label>
                        <input type="text" class="form-control" id="pdname" name="pdname" value="<?php echo $product['pdname']; ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="vat" name="vat" value="<?php echo $product['vat']; ?>" required>
                    </div>
        ...
        echo "<div class='alert alert-danger'>Không tìm thấy mặt hàng.</div>";
    }
} else {
    echo "<div class='alert alert-danger'>Không có ID mặt hàng.</div>";
}
